...
### 基础
*  [/pm](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm)
*  [/pm `sync`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-sync)
*  [/pm `info`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-info)
*  [/pm `verbose` \<on | record | off | paste\> [filter]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-verbose)
*  [/pm `tree` [selection] [max level] [player]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-tree)
*  [/pm `search` \<permission\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-search)
*  [/pm `check` \<user\> \<permission\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-check)
*  [/pm `networksync`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-networksync)
*  [/pm `import` \<file\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-import)
*  [/pm `export` \<file\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-export)
*  [/pm `reloadconfig`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-reloadconfig)
*  [/pm `bulkupdate`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-bulkupdate)
*  [/pm `migration`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-migration)
*  [/pm `creategroup` \<group\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-creategroup)
*  [/pm `deletegroup` \<group\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-deletegroup)
*  [/pm `listgroups`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-listgroups)
*  [/pm `createtrack` \<track\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-createtrack)
*  [/pm `deletetrack` \<track\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-deletetrack)
*  [/pm `listtracks`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-listtracks)

### 用户   (/pm user \<user\> ...)
*  [/pm user \<user\> `info`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-user-user-info)
*  [/pm user \<user\> `permission`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#permission---pm-user-user-permission---pm-group-group-permission-)
*  [/pm user \<user\> `parent`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#parent---pm-user-user-parent---pm-group-group-parent-)
*  [/pm user \<user\> `meta`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#meta---pm-user-user-meta---pm-group-group-meta-)
*  [/pm user \<user\> `editor`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-user-user-editor)
*  [/pm user \<user\> `switchprimarygroup` \<group\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-user-user-switchprimarygroup)
*  [/pm user \<user\> `promote` \<track\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-user-user-promote)
*  [/pm user \<user\> `demote` \<track\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-user-user-demote)
*  [/pm user \<user\> `showtracks`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-user-user-showtracks)
*  [/pm user \<user\> `clear` [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-user-user-clear)

### 组   (/pm group \<group\> ...)
*  [/pm group \<group\> `info`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-group-group-info)
*  [/pm group \<group\> `permission`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#permission---pm-user-user-permission---pm-group-group-permission-)
*  [/pm group \<group\> `parent`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#parent---pm-user-user-parent---pm-group-group-parent-)
*  [/pm group \<group\> `meta`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#meta---pm-user-user-meta---pm-group-group-meta-)
*  [/pm group \<group\> `editor`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-group-group-editor)
*  [/pm group \<group\> `listmembers` [page]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-group-group-listmembers)
*  [/pm group \<group\> `setweight` \<weight\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-group-group-setweight)
*  [/pm group \<group\> `showtracks`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-group-group-showtracks)
*  [/pm group \<group\> `clear` [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-group-group-clear)
*  [/pm group \<group\> `rename` \<new name\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-group-group-rename)
*  [/pm group \<group\> `clone` \<name of clone\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-group-group-clone)

### 权限   (/pm user \<user\> permission ... | /pm group \<group\> permission ...)
*  [`info`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-permission-info)
*  [`set` \<node\> \<true/false\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-permission-set)
*  [`unset` \<node\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-permission-unset)
*  [`settemp` \<node\> \<true/false\> \<duration\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-permission-settemp)
*  [`unsettemp` \<node\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-permission-unsettemp)
*  [`check` \<node\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-permission-check)
*  [`checkinherits` \<node\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-permission-checkinherits)

### 继承   (/pm user \<user\> parent ... | /pm group \<group\> parent ...)
*  [`info`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-info)
*  [`set` \<group\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-set)
*  [`add` \<group\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-add)
*  [`remove` \<group\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-remove)
*  [`settrack` \<track\> \<group\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-settrack)
*  [`addtemp` \<group\> \<duration\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-addtemp)
*  [`removetemp` \<group\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-removetemp)
*  [`clear` [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-clear)
*  [`cleartrack` \<track\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-cleartrack)

### 元数据   (/pm user \<user\> meta ... | /pm group \<group\> meta ...)
*  [`info`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-info)
*  [`set` \<key\> \<value\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-set)
*  [`unset` \<key\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-unset)
*  [`settemp` \<key\> \<value\> \<duration\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-settemp)
*  [`unsettemp` \<key\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-unsettemp)
*  [`addprefix` \<priority\> \<prefix\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-addprefix)
*  [`addsuffix` \<priority\> \<suffix\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-addsuffix)
*  [`removeprefix` \<priority\> [prefix] [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-removeprefix)
*  [`removesuffix` \<priority\> [suffix] [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-removesuffix)
*  [`addtempprefix` \<priority\> \<prefix\> \<duration\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-addtempprefix)
*  [`addtempsuffix` \<priority\> \<suffix\> \<duration\> [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-addtempsuffix)
*  [`removetempprefix` \<priority\> [prefix] [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-removetempprefix)
*  [`removetempsuffix` \<priority\> [suffix] [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-removetempsuffix)
*  [`clear` [context...]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-meta-clear)

### 轨道   (/pm track \<track\> ...)
*  [/pm track \<track\> `info`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-track-track-info)
*  [/pm track \<track\> `append` \<group\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-track-track-append)
*  [/pm track \<track\> `insert` \<group\> \<position\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-track-track-insert)
*  [/pm track \<track\> `remove` \<group\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-track-track-remove)
*  [/pm track \<track\> `clear`](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-track-track-clear)
*  [/pm track \<track\> `rename` \<new name\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-track-track-rename)
*  [/pm track \<track\> `clone` \<name of clone\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-track-track-clone)

### 日志   (/pm log ...)
*  [/pm log `recent` [user] [page]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-log-recent)
*  [/pm log `search` \<query\> [page]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-log-search)
*  [/pm log `notify` [on|off]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-log-notify)
*  [/pm log `export` \<file\>](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-log-export)
*  [/pm log `userhistory` \<user\> [page]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-log-userhistory)
*  [/pm log `grouphistory` \<group\> [page]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-log-grouphistory)
*  [/pm log `trackhistory` \<track\> [page]](https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-log-trackhistory)
...
如果 `primary-group-calculation` 选项被设置为不是 "stored" 的其他东西，你应该使用 `parent add`(https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-add) 或者 `parent set`(https://gitee.com/gu_zt666/MCDR-plugins/tree/PermissionsManger/docs/Command-Usage.md#pm-usergroup-usergroup-parent-set) 命令而不是这个命令。
